...
const socialLinks = [
  { icon: XIcon, href: "https://twitter.com/upshare_id", label: "X (Twitter)" },
  { icon: InstagramIcon, href: "https://instagram.com/upshare.id", label: "Instagram" },
  { icon: LinkedinIcon, href: "https://linkedin.com/company/upshare-id", label: "LinkedIn" },
  { icon: GithubIcon, href: "https://github.com/upshare-id", label: "GitHub" },
];
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-8 h-8 flex items-center justify-center rounded-lg bg-muted text-muted-foreground hover:bg-primary/10 hover:text-primary transition-all duration-200"
                  >
